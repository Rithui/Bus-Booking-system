...
class bus_booking:
    ...
    def cover_page(self):
        ...
        Label(root, text="\n\n\n\n\nName: Rithuik Prakash", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="\nEnr : 221B300", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="\nMobile : 8078238732\n\n\n\n", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="Submitted to: Dr. Mahesh Kumar", font='Arial 15 bold', bg='light blue', fg='red').pack()
        Label(root, text="Tkinter Project", font='Arial 15 bold', fg='red').pack()
            ...
            if tp.isalpha() and fp.isalpha():
                if not jd=='':
                    ...
                    if len(res_route)==0:
                        ...
                        #         val_route = str(j)
                        #         print(type(j))
                        for route_tuple in res_route:
                            val_route = str(route_tuple[0])
                            print(f"Route ID: {val_route}")
